  ...
  <View style={styles.Map.container}>
    <View style={styles.Table}>
      <View style={styles.overlayStyle}>
        <Image source={Muebles} 
          style={absolutePositionFactory({ bottom: "1%", right: "1%", height: "20%", width: "20%" })} 
        />
        <Image source={Comedor}
          style={absolutePositionFactory({ top: "55%", left: "2.5%", width: "35%", height: "20%" })} 
        />
        <Image source={ServicioHigiénico} 
          style={absolutePositionFactory({ top: "1%", left: "15%", height: "5%" })} 
        />
        <Image source={Cocina} 
          style={absolutePositionFactory({ top: "0%", right: "7.5%", height: "15%", width: "25%" })} 
        />
      </View>
